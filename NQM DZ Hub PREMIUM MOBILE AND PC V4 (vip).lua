...
local Window = Fluent:CreateWindow({
    Title = "NQM DZ",
    SubTitle = "[PREMIUM] true v4 https://discord.gg/BVuYYKkVeJ",
    TabWidth = 160,
...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Island", Icon = "island" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "apple" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "gun " }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "human" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shop" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "music" }),
    Hop = Window:AddTab({ Title = "Hop", Icon = "gear" }),
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Chọn Chức năng Cày Thông Thạo",
        Description = "",
